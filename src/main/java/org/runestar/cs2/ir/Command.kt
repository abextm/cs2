...
interface Command {
    ...
    enum class Basic(
        ...
        _6700(listOf(INT, INT, STRING), listOf()),
        _6701(listOf(INT), listOf()),
        _6702(listOf(INT, INT, STRING), listOf()),
        _6703(listOf(INT), listOf()),
        _6704(listOf(INT, INT, STRING), listOf()),
        _6705(listOf(INT), listOf()),
        _6706(listOf(INT, INT, STRING), listOf()),
        _6707(listOf(INT), listOf()),
        _6708(listOf(INT, INT, STRING), listOf()),
        _6709(listOf(INT), listOf()),
        
        _6750(listOf(), listOf(STRING)),
        _6751(listOf(), listOf(INT)),
        ...
        _7001(listOf(INT, INT, INT), listOf()),
        _7002(listOf(INT, INT, INT), listOf()),
        ...
        _7200(listOf(INT, INT, INT, INT, INT), listOf(INT)),
